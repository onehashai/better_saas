	...
	function get_cart_value() {
		frappe.call('better_saas.www.upgrade.get_cart_details', {
			...
			cart_reponse.forEach(cart_row => {
                ...
                <div class="col-md-2 col-xs-3 py-2 px-3 text-center text-nowrap">
                    <input class="form-control cart-qty" min="1" data-upgrade-type="${cart_row.upgrade_type}" data-current-value="${cart_row.value}" type="number" value="${cart_row.value}" id="${cart_row.upgrade_type}" >
                </div>
